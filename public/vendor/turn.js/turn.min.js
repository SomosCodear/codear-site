  ...
  var z,
    ...
    g = {
      init: function (a) {
        ...
        var b;
        U = (b = /AppleWebkit\/([0-9\.]+)/i.exec(navigator.userAgent))
        ...
        f(this)
          .bind(r.down, d.eventHandlers.touchStart)
        ...
        f(document)
          .bind(r.move, d.eventHandlers.touchMove)
          .bind(r.up, d.eventHandlers.touchEnd);
      ...
      destroy: function () {
        ...
        if ('prevented' != t('destroying', this)) {
          ...
          for (
            f(document)
              .unbind(r.move, b.eventHandlers.touchMove)
              .unbind(r.up, b.eventHandlers.touchEnd);
            0 !== b.totalPages;
      ...
      resize: function () {
        var a,
          b = this.data();
        b.pages[0] &&
          (b.pageWrap[0].css({ left: -this.width() }), b.pages[0].flip('resize', !0));
        ...
        if (this.turn('animating')) {
          ...
          for (c = 0; c < h.pageMv.length; c++)
            h.pageMv[c] &&
              ...
              d.force &&
                ((d.next = 0 === d.page % 2 ? d.page - 1 : d.page + 1), delete d.force));
        }
        this.turn('update');
        return this;
      },
      ...
      _updateShadow: function () {
        ...
        a = this.turn('view');
        c.shadow ||
          (c.shadow = f('<div />', { class: 'shadow', css: l(0, 0, 0).css }).appendTo(
            this,
          ));
        for (var i = 0; i < c.pageMv.length && a[0] && a[1]; i++)
          (a = this.turn('view', c.pages[c.pageMv[i]].data().f.opts.next)),
            ...
            (a[1] = a[1] && b[1]);
        switch (
          a[0] ? (a[1] ? 3 : 'ltr' == c.direction ? 2 : 1) : 'ltr' == c.direction ? 1 : 2
        ) {
          case 1:
      ...
      options: function (a) {
        ...
        if (a.when)
          for (var c in a.when) n(c, a.when) && this.unbind(c).bind(c, a.when[c]);
        return this;
      },
      version: function () {
        return '4.1.0';
    ...
    i = {
      ...
      options: function (a) {
        var b = this.data().f;
        return a
          ? (i.setData.call(this, { opts: f.extend({}, b.opts || Y, a) }), this)
          : b.opts;
      },
      z: function (a) {
        var b = this.data().f;
        ...
        if (!a.wrapper)
          switch (a.effect) {
            ...
            case 'sheet':
              ...
              a.fparent ||
                ((d = f('<div/>', { css: { 'pointer-events': 'none' } }).hide()),
                (d.data().flips = 0),
          ...
          case 'hard':
            ...
            switch (a.corner) {
              case 'l':
                ...
                k = '100% 50%';
                t
                  ? ((f = 0), (g = 0 < b.opts.next - 1), (s = 1))
                  : ((f = '100%'), (g = b.opts.page + 1 < n), (s = 0));
                break;
              case 'r':
                (x = '100% 50%'),
                  (k = '0% 50%'),
                  ...
                  (e = -e),
                  t
                    ? ((f = 0), (g = b.opts.next + 1 < n), (s = 0))
                    : ((f = '-100%'), (g = 1 != b.opts.page), (s = 1));
            }
            ...
            t
              ...
              : ((p -= 1), b.wrapper.css({ zIndex: l }), b.fpage.css({ zIndex: l + 1 }));
            c.opts.gradients &&
              (g
                ? b.ashadow
                    .css({
            ...
            var O = c.opts.acceleration,
              ...
              I = function () {
                ...
                g > L &&
                  ((b = K - g),
                  (f = R - h / Math.sin(b)),
                  (v = j(Math.round(f * Math.cos(b)), Math.round(f * Math.sin(b)))),
                  C && (v.x = -v.x),
                  E && (v.y = -v.y));
                ...
                c.opts.gradients &&
                  ...
                  i._backGradient.call(u) &&
                    ((B = j(
                      100 * ((1.2 * y * Math.sin(g)) / e),
                      100 * ((1.2 * y * Math.cos(g)) / h),
                    )),
                    C || (B.x = 100 - B.x),
                    E || (B.y = 100 - B.y)));
                m.x = Math.round(m.x);
            ...
            f = function (a, d, f, g) {
              ...
              b.fpage
                ...
                .transform(
                  G(g) +
                    F(
                      a.x + Q.x - v.x - (e * f[0]) / 100,
                      a.y + Q.y - v.y - (h * f[1]) / 100,
                      O,
                    ) +
                    G((180 / g - 2) * g),
                  s,
            ...
            if (
              ((c =
                ...
                e.opts.turn.data().mouseAction
                  ...
                  : null),
              (f = !1),
              'prevented' == t('start', this, [e.opts, c]))
            )
              return !1;
          if (b) {
            var g = this,
      ...
      _eventEnd: function () {
        ...
        !a.disabled &&
          b &&
          'prevented' != t('released', this, [a.point || b]) &&
